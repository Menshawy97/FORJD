...
const kForjdIconPaths = <String, List<String>>{
  ...
  'rank': [
    'M7.4 4.6h9.2v3.6a4.6 4.6 0 0 1-9.2 0z',
    'M12 12.8v3.4M8.4 19.4h7.2',
  ],
  'profile': [
  ...
  'star': [
    'm12 4.6 2.3 4.9 5.1.7-3.7 3.7.9 5.2-4.6-2.5-4.6 2.5.9-5.2L4.6 10.2l5.1-.7z',
  ],
  'search': [
    'M5.4 11a5.6 5.6 0 1 0 11.2 0 5.6 5.6 0 1 0-11.2 0',
    'm15.4 15.4 3.4 3.4',
  ],
  'clock': [
    'M4.2 12a7.8 7.8 0 1 0 15.6 0 7.8 7.8 0 1 0-15.6 0',
    'M12 7.6V12l3 2',
  ],
