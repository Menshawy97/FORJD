      ...
      customExercises: [
        {
          ...
          secondaryMuscles: [],
          equipment: ['cable'],
          instructions: ['Curl the handle to shoulder height.'],
          description: null,
        },
      ],
      favouriteExerciseIds: ['bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb'],
      customFoods: [
        {
          id: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc',
          name: 'Protein bar',
      ...
      savedMeals: [
        {
          ...
          items: [{ foodId: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', servingLabel: '1 bar', grams: 45 }],
        },
      ],
      goals: [{ type: 'weight', targetValue: 80, targetDate: '2026-12-31', status: 'active' }],
      preferences: { timezone: 'Africa/Cairo', locale: 'en', notificationsEnabled: true },
      healthConnections: [{ source: 'health_connect', lastSuccessfulSyncAt: '2026-09-01T10:00:00.000Z' }],
      programEnrollmentHistory: [
        {
          id: 'eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee',
          programId: 'ffffffff-ffff-4fff-8fff-ffffffffffff',
          programVersion: 1,
